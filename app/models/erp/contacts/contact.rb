module Erp::Contacts
  class Contact < ApplicationRecord
    ...
    def sales_orders_is_payment_for_contact
      sales_orders.where(payment_for: Erp::Payments::PaymentType::TYPE_FOR_CONTACT)
    end
    ...
    def sales_paid_amount(params={})
      query = Erp::Payments::PaymentRecord.where(status: Erp::Payments::PaymentRecord::STATUS_DONE)
                                          ...
                                          .where(erp_payments_payment_types: {code: Erp::Payments::PaymentType::TYPE_FOR_CONTACT})
                                          .where(contact_id: self.id)
      if params[:from].present?
